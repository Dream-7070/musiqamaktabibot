...
echo "=================================================="
echo ""
echo "QO'LDA BAJARILADIGAN QADAM (bittasi qoldi):"
echo ""
echo " Google Drive ulanishi. Avtomatlashtirib bo'lmaydi -"
echo " avtorizatsiya brauzerda tasdiqlanadi:"
echo ""
echo "   1) Maktab akkauntida credentials.json oling"
echo "      (Cloud Console -> Credentials -> OAuth client ID, Desktop app)"
echo "   2) Kompyuterda: python scripts/get_token.py"
echo "   3) credentials.json va token.json ni shu papkaga qo'ying:"
echo "        $TARGET_DIR/"
echo "   4) chown $RUN_USER:$RUN_USER $TARGET_DIR/{credentials,token}.json"
echo "      chmod 600 $TARGET_DIR/{credentials,token}.json"
echo "   5) systemctl restart school-bot@$SLUG"
echo ""
echo " DIQQAT: Cloud Console -> OAuth consent screen -> PUBLISH APP."
echo " Ilova \"Testing\" holatida qolsa token 7 kunda o'ladi va"
echo " hujjatlar yuklanmay qoladi."
echo ""
echo "Mini App menyu tugmasi QO'LDA sozlanmaydi - bot ishga"
echo "tushganda uni o'zi qo'yadi (main.py, set_chat_menu_button)."
echo "Manzil: https://$DOMAIN"
echo ""
echo "Oxirida: adminlar botga /start yuborib tekshirsin."
echo ""
